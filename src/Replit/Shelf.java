...
public class Shelf {
        ...
        public static boolean isShelfEmpty(){
            if(theBooks.isEmpty()) return true;
            else return false;
        }
        ...
        public static boolean isIDUnique(int id){
            ...
            for(int i = 0; i < theBooks.size(); i++) {
                if(theBooks.get(i).getId() == id) count++;
            }
        ...
        public static boolean addBook(int id, String author, String title, int pages ){
            ...
            else if (isIDUnique(id) && (pages > 0) && !title.isEmpty()) {
                theBooks.add(new Book(id,author,title,pages));
                return true;
            }
            return true;
        ...
        public static boolean addBook(Book book ){
            ...
            else if (isIDUnique(book.getId()) && !book.getTitle().isEmpty() || book.getPages() > 0) {
                theBooks.add(book);
                return true;
            }
            return true;
        ...
        public static String getTitleByID(int id) {
            ...
            int count = 0;
            for(int i = 0; i < theBooks.size(); i++) {
                if (theBooks.get(i).getId() == id) title = theBooks.get(i).getTitle();
            }
        ...
        public static Book findBookByPartialTitle(String title) {
            ...
            if(index > 0) return theBooks.get(index);
            else return null;
        ...
        for(int i = 0; i < theBooks.size(); i++) {
            if(theBooks.get(i).getAuthor().toLowerCase().equals(author.toLowerCase())) {
                authorBooks.add(theBooks.get(i));
            }
        }
